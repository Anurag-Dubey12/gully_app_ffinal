...
class GoogleMapSearchPlacesApiState extends State<GoogleMapSearchPlacesApi> {
  ...
  //Function to get The Place Suggestions
  //This function will be called when the user types in the search bar
  void getSuggestion(String input) async {
    const String placesApiKey = AppConstants.googleApiKey;
  ...
  //This function will be called when the user selects a place from the list
  //it will return the Latitude and Longitude of the selected Place
  Future<void> getPlaceDetails(String placeId, String description) async {
    ...
    try {
      ...
      String request = '$baseURL?placeid=$placeId&key=$placesApiKey';
...
//Previous Code For search Location but due to some issues with the package we are using the above code
