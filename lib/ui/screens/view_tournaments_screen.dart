                ...
                child: !connectionController.isConnected.value
                    ...
                    : ListView.separated(
                        ...
                        itemBuilder: (context, index) {
                          final torunamentReverseOrder = controller
                              .organizerTournamentList.reversed
                              .toList();
                          return _TourCard(torunamentReverseOrder[index], () {
                            setState(() {});
                          }
...
class _TourCard extends GetView<TournamentController> {
  ...
  Widget build(BuildContext context) {
    return ListTile(
        ...
        trailing: tournament.tournamentEndDateTime.isBefore(DateTime.now())
            ? const Chip(
