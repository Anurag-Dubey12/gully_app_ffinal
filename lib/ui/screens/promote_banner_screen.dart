              ...
              child: Column(
                ...
                children: [
                  ...
                  FormInput(
                    ...
                    infotext: "Your banner will be displayed within a 25Km radius of the selected location. "
                  ...
                  const SizedBox(height: 10),
                  Text("Select Your Suitable Banner Package",style: Get.textTheme.headlineMedium?.copyWith(
                      fontWeight: FontWeight.bold,
                      color: Colors.black,
                      fontSize: 16)),
                  const SizedBox(height: 10),
                  SizedBox(
                    ...
                    child: GestureDetector(
                      onTap: () async {
                        final result = await Get.to(() =>  PackageScreen(package:package));
