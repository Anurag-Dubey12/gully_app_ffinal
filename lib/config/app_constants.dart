...
class AppConstants {
  ...
  static const String name_cannot_contain_special_characters = "Name cannot contain special characters";
  static const String name_cannot_contain_emojis = "Name cannot contain emojis";
  static const String name_cannot_contain_special_characters_numbers = "Name cannot contain special characters & numbers";
  static const String contact_no = "Contact No";
  static const String please_enter_valid_phone_number = "Please enter a valid phone number";
  static const String please_select_an_image = "Please select an image";
  static const String please_select_a_valid_image = "Please select a valid image";
  static const String please_enter_5_digit_code = "Enter 5 digit code sent to your mobile number";
  ...
  static const String pleaseEnterTournamentName = "Please enter tournament name";
  static const String tournamentNameCannotContainEmojis = "Tournament name cannot contain emojis";
  static const String tournamentStartDateShouldBeLessThanEndDate = "Tournament start date should be less than end date";
  static const String pleaseSelectTournamentStartDate = "Please select tournament start date";
  static const String tournamentEndDateShouldBeGreaterThanStartDate = "Tournament end date should be greater than start date";
  ...
  static const String pleaseEnterCohost1ContactNo = "Please enter co-host 1 contact no";
  ...
  static const String pleaseEnterValidCohost1ContactNo = "Please enter a valid co-host 1 contact no";
  static const String cohost1AndCohost2ContactNoCannotBeSame = "Co-host 1 and Co-host 2 contact no cannot be same";
  static const String pleaseEnterValidContactNo = "Please enter a valid contact no";
  ...
  static const String pleaseEnterValidEntryFee = "Please enter a valid entry fee";
  static const String entryFeeCannotStartWith0 = "Entry fee cannot start with 0";
  static const String ballCharges = "Ball Charges";
  static const String pleaseEnterBallCharges = "Please enter ball charges";
  static const String pleaseEnterValidBallCharges = "Please enter a valid ball charges";
  static const String breakfastCharges = "Breakfast Charges";
  static const String pleaseEnterBreakfastCharges = "Please enter breakfast charges";
  static const String pleaseEnterValidBreakfastCharges = "Please enter valid breakfast charges";
  static const String teamLimit = "Team Limit";
  static const String pleaseEnterTeamLimit = "Please enter team limit";
  static const String pleaseEnterValidTeamLimit = "Please enter a valid team limit";
  static const String teamLimitShouldBeEqualOrGreaterThan2 = "Team limit should be equal or greater than 2";
  ...
  static const String deletePlayerConfirmation = "Are you sure you want to delete this Player";
  static const String addViaPhoneNumber = "Add via phone number";
  static const String addFromContacts = "Add from contacts";
  static const String selectContactWithName = "Please select a contact with a name";
  static const String selectContactWithPhoneNumber = "Please select a contact with a phone number";
  ...
  static const String teamCreatedSuccessfully = "Congratulations!\nYour team has been successfully created.";
  ...
  static const String teamNameValidationMessage = "Team name should be at least 3 characters long";
  static const String teamNameValidationPattern = "Team name should contain only alphabets and numbers, and allow spaces between words without consecutive spaces";
  ...
  static const String teamNameLengthError = "Team name should be at least 3 characters long";
  static const String challengeTeamTitle = "Challenge Team";
  static const String challengeTeamMessage = "Please pay Rs.200/- to challenge a team";
  ...
  static const String shortMessageError = "Message should be at least 20 characters long";
  static const String thankYouMessage = "Thank you for contacting us.";
  static const String replySoonMessage = "Your request has been sent successfully. Please wait for the revert. We will get back to you in 2-3 working days.";
  static const String submitButton = "Submit";
  static const String okButton = "OK";
  static const String emailInfo = "info@nileegames.com";
  static const String addressInfo = "508, 5th floor, Fly Edge building, S.V. Road, Borivali East";
  ...
  static const String deleteAccountConfirmation = "If you want to delete your account, please click the button below. Your account will be deleted permanently and you will not be able to recover it.";
  ...
  static const String bannerwarningtext='To ensure your banner displays properly, make sure it meets the recommended size.\n\n'
