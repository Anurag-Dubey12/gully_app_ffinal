                  ...
                  Padding(
                    ...
                    child: FutureBuilder<String>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        final isFAQ = content.contains('type: faq') ||
                            content.contains('<strong>');
                        final isdisclaimer =
                            content.contains('type: disclaimer') ||
                                content.contains('<p>');
                        final isPolicy =
                            content.contains('type: privacy-policy') ||
                        ...
                        if (isFAQ) {
                          ...
                          for (var i = 0; i < paragraph.length; i++) {
                            final p = paragraph[i];
                            if (p.text.trim().startsWith(RegExp(r'\d+\.')) ||
                                p.getElementsByTagName('strong').isNotEmpty) {
