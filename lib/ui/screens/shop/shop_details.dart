                ...
                children: [
                  Row(
                    children: [
                      CircleAvatar(
                        radius: 40,
                        backgroundImage: AssetImage(shop['logo'] ?? 'assets/images/logo.png'),
                      ),
                ...
                children: [
                  Column(
                    children: [
                      ...
                      const SizedBox(height: 4),
                      Text('${shop['rating'] ?? 0}', style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                  ...
                  Column(
                    children: [
                      ...
                      const SizedBox(height: 4),
                      Text('${shop['totalProducts'] ?? 0}', style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
