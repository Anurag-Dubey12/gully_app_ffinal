...
class Product extends State<AddProduct> {
  ...
  pickImages() async {
    ...
    if (imgs != null && imgs.isNotEmpty) {
      ...
      if (kDebugMode) {
        print("Added images: ${imgs.length}, Remaining: $remainingSlots");
      }
    }
  }
    ...
    return DecoratedBox(
      ...
      child: GradientBuilder(
        child: Scaffold(
          ...
          bottomNavigationBar: Container(
            ...
            child: Expanded(
              child: PrimaryButton(
                  ...
                  try {
                    if (_formKeys.currentState!.validate()) {
                      ...
                      Map<String, dynamic> product = {
                        ...
                        "discountedvalue":
                            isDiscount ? int.parse(_discountController.text) : 0
                      };
                      if (widget.product != null) {
                ...
                title: widget.product != null ? 'Edit Product' : 'Save Product',
              ),
            ),
          ),
          ...
          //                       );
          //                       await controller.getProduct(widget.product!.id);
          //                       await controller.getShopImageCount(
