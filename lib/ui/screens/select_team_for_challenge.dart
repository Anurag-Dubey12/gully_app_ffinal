...
class SelectTeamForChallenge extends StatefulWidget {
  const SelectTeamForChallenge({
    super.key,
  });

  @override
  State<SelectTeamForChallenge> createState() => _SelectTeamForChallengeState();
}

class _SelectTeamForChallengeState extends State<SelectTeamForChallenge> {
  @override
              ...
              Material(
                child: InkWell(
                  ...
                  onTap: () async {
                    ...
                    Get.off(() => SearchChallengeTeam(team: team));
                  },
                  child: Ink(
                      width: 30,
                      height: 30,
