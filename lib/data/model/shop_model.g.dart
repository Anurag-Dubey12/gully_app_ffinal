...
ShopModel _$ShopModelFromJson(Map<String, dynamic> json) => ShopModel(
      ...
      businesslicenseNumber: json['LicenseNumber'] as String?,
      totalEditDone: (json['TotalEditDone'] as num).toInt(),
...
Map<String, dynamic> _$ShopModelToJson(ShopModel instance) => <String, dynamic>{
      ...
      'LicenseNumber': instance.businesslicenseNumber,
      ...
      'TotalEditDone': instance.totalEditDone,
