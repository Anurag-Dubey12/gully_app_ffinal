...
class _MatchupsScreen extends State<ViewMatchupsScreen>
                    ...
                    : TabBarView(
                        ...
                        children: [
                          ...
                          FutureBuilder<List<PointTableModel>>(
                            future: controller.tournamentPointsTable(
                            ...
                            builder: (context, snapshot) {
                              ...
                              if (snapshot.data!.isEmpty) {
                                return const Center(
                                  child: Text(
                                      "Points table will be available once your team is registered.",
                                      textAlign: TextAlign.center),
                                );
                              }
                        ...
                        actions: [
                          ...
                          ElevatedButton(
                            ...
                            onPressed: () async {
                              Get.close();
                              final isDeleted =
                                  await controller.deleteMatch(matchup.id);
                              if (isDeleted) {
                                successSnackBar("Your match has been deleted");
                                controller
                                    .tournamentPointsTable(tourId?.id ?? '');
                              } else {
